    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approve', models.BooleanField(blank=True, default=False, help_text='Check to Accept & Save/Submit(FOR EMPLOYER)')),
                ('accept', models.BooleanField(blank=True, default=False, help_text='Check to Accept & Save/Submit(FOR TASKER)')),
            ],
            options={
                'db_table': 'e_bids',
                'ordering': ('created_at',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('title', models.CharField(blank=True, help_text='Write Short  title here', max_length=255, null=True)),
                ('dfile', models.FileField(blank=True, null=True, upload_to='media/documents/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rejected', models.BooleanField(blank=True, default=False, help_text='FOR EMPLOYER.You need to provide rejection_description')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('title', models.CharField(blank=True, help_text='Write Short title here', max_length=255, null=True)),
                ('document', models.FileField(blank=True, null=True, upload_to='media/documents/%Y/%m/%d/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.FileField(blank=True, null=True, upload_to='media/documents/%Y/%m/%d/')),
                ('final', models.BooleanField(blank=True, default=False, help_text='Check for Final Submission')),
